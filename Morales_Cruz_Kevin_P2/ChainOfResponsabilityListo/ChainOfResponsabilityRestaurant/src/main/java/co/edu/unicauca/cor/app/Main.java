...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        claim = new Claim(4, "Producto equivocado", "Me enviaron el pedido que no era", TypeEnum.LOST);
        manager.getLevelOne().attend(claim);
        claim = new Claim(5, "Garantia", "El pedido esta defectuoso no funciona", TypeEnum.UNCLASSIFIED);
        manager.getLevelOne().attend(claim);
