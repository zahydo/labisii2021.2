...
import co.edu.unicauca.commandrestaurant.infra.Messages;
...
public class GUIFood extends javax.swing.JFrame {
    ...
    private void addFood(int id, String name, FoodTypeEnum type) {
        Food food = new CryptFood(new CapitalFood(new BaseFood(id, name, type)));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        int id = Integer.parseInt(txtId.getText());
        String type = cboType.getSelectedItem().toString();
        FoodTypeEnum foodType = FoodTypeEnum.valueOf(type);

        // Crea la comida con los nuevos datos
        Food food = new CryptFood(new CapitalFood(new BaseFood(id, name, foodType)));
        ...
        Food previous = new BaseFood(compAux.getId(), compAux.getName(), compAux.getType());
    ...
    private void txtIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIdFocusLost
        ...
        if (food == null) {
            ...
            btnUndo.setEnabled(false);
            try {
                if (Utilities.loadProperty("crypt").equals("true")) {
                    txtName.setText(SecurityService.decrypt(food.getName()));
                } else {
                    txtName.setText(food.getName());
                }
            } catch (Exception e) {
                Logger.getLogger(GUIFood.class.getName()).log(Level.SEVERE, null, e);
            }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        invoker.execute();
        Food compAux = findByIdCommand.getFood();
        Food foodSaved = new BaseFood(compAux.getId(), compAux.getName(), compAux.getType());
