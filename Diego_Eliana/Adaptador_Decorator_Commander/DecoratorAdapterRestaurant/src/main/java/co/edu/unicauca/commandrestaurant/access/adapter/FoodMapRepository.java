...
public class FoodMapRepository {
    ...
    private void initData() {
        components.put(1,   new CryptFood(
                                new CapitalFood(
                                    new BaseFood(1, "Fríjoles", FoodTypeEnum.PRINCIPIO))));
        components.put(2,   new CryptFood(
                                new CapitalFood(
                                        new BaseFood(2, "Sopa de verduras", FoodTypeEnum.ENTRADA))));
        components.put(3,   new CryptFood(
                                new CapitalFood(
                                        new BaseFood(3, "Jugo de mango", FoodTypeEnum.JUGO))));
    }
    /**
