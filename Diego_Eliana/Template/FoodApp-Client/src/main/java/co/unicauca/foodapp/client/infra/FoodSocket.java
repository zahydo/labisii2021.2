package co.unicauca.foodapp.client.infra;
...
public class FoodSocket {
    ...
    public String sendStream(String requestJson) throws IOException {
        ...
        output.println(requestJson);    // Enviar la solicitud

        if (input.hasNextLine()) {      // Procesa la respuesta
    ...
    public void disconnect() {
        try {
            ...
            Logger.getLogger(FoodSocket.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
