package co.unicauca.foodapp.client.presentation;

import co.unicauca.foodapp.domain.FindByIdCommand;
import co.unicauca.foodapp.domain.DeleteCommand;
import co.unicauca.foodapp.domain.UpdateCommand;
import co.unicauca.foodapp.domain.FindAllCommand;
import co.unicauca.foodapp.domain.Invoker;
import co.unicauca.foodapp.domain.CreateCommand;
import co.unicauca.foodapp.commons.domain.Food;
import co.unicauca.foodapp.commons.domain.FoodTypeEnum;
import co.unicauca.foodapp.commons.infra.Messages;
...
public class GUIFood extends javax.swing.JFrame {
    ...
    /**
     * Lista los tipos de comida en el jComboBox
     */
    ...
    /**
     * Invoker ejecuta el comando para crear una Food nueva
     * @param id de la comida
     * @param name de la comida
     * @param type de comida
     */
    private void addFood(int id, String name, FoodTypeEnum type) {
        Food foodComponent = new Food(id, name, type);

        invoker.setCommand(new CreateCommand(foodComponent));   //Fija el comando del invoker
        invoker.execute();  //Ejecuta el comando
    }
    ...
    /**
     * Invoker ejecuta el comando para actualizar una Food con los nuevos valores
     * @param food a editar
     * @param previous Food antes de ser modificada
     */
    ...
    private void txtIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIdFocusLost
        ...
        invoker.setCommand(new FindByIdCommand());
        FindByIdCommand findByIdCommand = (FindByIdCommand) invoker.getCommand(); //Pasa parámetros al comando
        findByIdCommand.setFoodId(Integer.parseInt(strId));
        invoker.execute(); //Ejecuta el comando
        Food food = findByIdCommand.getFood();

        if (food == null) { //Agregar
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        // Crea la comida con los datos de la comida seleccionada
        Food food = new Food(id, txtName.getText(), foodTpye); 
        
        //Eliminar la comida y guarda el previo
        eliminarComida(food);

        Messages.successMessage("Comida borrada con éxito", "Atención");
        clearControls();
        initStateButtons();
        loadDataTable();
