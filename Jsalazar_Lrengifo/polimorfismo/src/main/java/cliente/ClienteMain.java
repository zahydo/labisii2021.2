...
public class ClienteMain {
    ...
    */
    public static void leerViajes() {
        try{
            Viaje viaje1 = new ViajeFamiliar("Popayán", "Bogotá", 
                                            1250000, 
            ...
            Viaje viaje2 = new ViajeIncentivo("Popayán",
                                            "Medellin", 
                                            2100000, 
            ...
            Viaje viaje3 = new ViajeIndividual("Popayán", 
                                              "San Andres", 
                                              4250000,
            ...
            Viaje viaje4 = new ViajeTodoIncluido("Popayán", 
                                                "Cartagena",
                                                7350000,
                                                new SimpleDateFormat("dd/MM/yyyy").parse("01/07/2019"), 
                                                new SimpleDateFormat("dd/MM/yyyy").parse("12/07/2019"));
