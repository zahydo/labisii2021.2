...
public class GUIFood extends javax.swing.JFrame {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int foodId = Integer.parseInt(txtId.getText());

        // Retornar la comida a eliminar por Id
        invoker.setCommand(new FindByIdCommand());
        FindByIdCommand findByIdCommand = (FindByIdCommand) invoker.getCommand();
        findByIdCommand.setFoodId(foodId);
        invoker.execute();

        Food foodToDelete = findByIdCommand.getFood();

        removeFood(foodToDelete);

        Messages.successMessage("Comida eliminada con exito", "Atencion");
        clearControls();
        initStateButtons();
        loadDataTable();
