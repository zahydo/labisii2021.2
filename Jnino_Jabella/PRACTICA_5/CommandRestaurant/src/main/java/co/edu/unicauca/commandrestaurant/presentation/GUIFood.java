...
public class GUIFood extends javax.swing.JFrame {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        int id = Integer.parseInt(txtId.getText());       
        invoker.setCommand(new FindByIdCommand()); // Obtener la comida anterior
        FindByIdCommand findByIdCommand = (FindByIdCommand) invoker.getCommand();
        findByIdCommand.setFoodId(id);
        invoker.execute();
        Food compAux = findByIdCommand.getFood();
        Food previous = new Food(compAux.getId(), compAux.getName(), compAux.getType()); // sea crea una copia para guardar los datos
        //En caso de deshacer
        invoker.setCommand(new DeleteCommand(findByIdCommand.getFood()));
        DeleteCommand deleteCommand = (DeleteCommand) invoker.getCommand();
        deleteCommand.setFoodId(id);
        deleteCommand.setCopyFoodAnt(previous);
        invoker.execute();
        Messages.successMessage("Se elimino la comida exitosamente", "Atención");
        clearControls();
        initStateButtons();
        loadDataTable();      
