...
import static co.unicauca.Restaurante.client.infra.Messages.warningMessage;
...
public class GUIMenu extends javax.swing.JFrame {
    ...
    private void ponerUsuarioLogueado() {
        ...
        if (co.unicauca.Restaurante.client.infra.Security.usuario == null) {
            this.mnuEmpleadoLogueado.setText("(Anónimo)");
        } else {
            this.mnuEmpleadoLogueado.setText("(" + co.unicauca.Restaurante.client.infra.Security.usuario.getLogin() + ")");
        }
