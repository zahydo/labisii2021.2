...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        claim = new Claim(4, "Producto equivocado", "Me enviaron el pedido que no era", TypeEnum.VERY_HIGH);
        manager.getLevelOne().attend(claim);
        
        claim = new Claim(5, "Entrega sin el producto", "Sorpresivamente, el mensajero llegó con un blister que se encontraba vacío", TypeEnum.UNCLASSIFIED);
        manager.getLevelOne().attend(claim);
    }
