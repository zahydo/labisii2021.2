...
import co.edu.unicauca.layersmvc.infra.Notify;
import com.google.gson.Gson;
/**
 *
 * @author ahurtado
 */
public class GUIEditProductViewController extends javax.swing.JFrame {

    ServiceModel service;
    Product p;
    private Notify Notificar;
     ...
     * @param p Producto
     */
    public GUIEditProductViewController(ServiceModel service, Product p) {
        initComponents();
        ...
        txtValue.setText("" + p.getPrice());
        setSize(400, 300);
        Notificar = new Notify();
    }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        //LLama al modelo para modificar un producto
        service.updateProduct(newProduct);
        Gson gson = new Gson();
        String msgJsonProducto = gson.toJson(newProduct);
        Notificar.NotifyAllObserves("Se ha modificado un producto ",msgJsonProducto,"modificar");
