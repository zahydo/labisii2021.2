...
public class ServiceModel extends Subject {
    ...
    public boolean saveProduct(Product newProduct) {
        ...
        // Le notifica al observador mediante un formato Gson indicando el tipo de acción 
        Gson objGson = new Gson();
        String cadenaGson = objGson.toJson(newProduct);
        cadenaGson.replace("'", "");
        String tipoRepos = "post-";
        this.notifyAllObserves(tipoRepos.concat(cadenaGson));
