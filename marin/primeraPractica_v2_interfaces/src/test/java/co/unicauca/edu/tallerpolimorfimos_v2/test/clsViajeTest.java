...
package co.unicauca.edu.tallerpolimorfimos_v2.test;
...
/**
 * Clase para las pruebas unitarias de las clases de la capa de modelo
 * @author David Marín
 */
public class clsViajeTest 
{
    ...
    /**
     * Test de la clase claViajeIncentivo
     * @throws java.text.ParseException
     */
    @Test
    ...
    /**
     * Test de la clase clsViajeIndividual
     * @throws java.text.ParseException
     */
    @Test
     ...
     */
    @Test
    public void clsViajeTodoIncluido() throws ParseException
    {
