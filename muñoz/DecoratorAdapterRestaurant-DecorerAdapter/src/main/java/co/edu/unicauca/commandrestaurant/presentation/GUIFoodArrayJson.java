 ...
 *
 */
public class GUIFoodArrayJson extends javax.swing.JFrame {
    ...
    private void loadDataTable()  {
            try {
                ...
                Logger.getLogger(GUIFoodArrayJson.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
    ...
    private void addFood(int id, String name, FoodTypeEnum type) throws Exception {
        Food food = new CryptFood(id, name, type).getFood();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
            try {                                          
                ...
                Food food = null;
                try {
                    food = (new CryptFood(id, name, foodTpye)).getFood();
                } catch (Exception ex) {
                    Logger.getLogger(GUIFoodArrayJson.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void txtIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIdFocusLost
            try {
                ...
                if (food == null) {
                    ...
                    btnUndo.setEnabled(false);
                    try {
                        txtName.setText(SecurityService.decode(food.getName()));
                    } catch (Exception ex) {
                        Logger.getLogger(GUIFoodArrayJson.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    public static void main(String[] args) {
        GUIFoodArrayJson gui = new GUIFoodArrayJson();
        gui.setVisible(true);
    }
