...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        claim = new Claim(4, "Producto equivocado", "Me enviaron el pedido que no era", TypeEnum.HIGHER);
        manager.getLevelOne().attend(claim);
        
        claim = new Claim(5, "Producto equivocado", "Encontre algo extraño en mi comida y quiero que me indemnicen por los daños recibidos", TypeEnum.UNCLASSIFIED);
        manager.getLevelOne().attend(claim);
    }
