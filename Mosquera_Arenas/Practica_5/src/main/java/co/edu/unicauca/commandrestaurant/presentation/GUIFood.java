...
public class GUIFood extends javax.swing.JFrame {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        //Fija el comando del invoker para buscar comida por id y guardar la comida eliminada
        invoker.setCommand(new FindByIdCommand());
        //Pasa parámetros al comando
        FindByIdCommand findByIdCommand = (FindByIdCommand) invoker.getCommand();
        findByIdCommand.setFoodId(Integer.parseInt(strId));
        //Ejecutamos el comando para que nos retorne la comida eliminada
        invoker.execute();
        Food compAux = findByIdCommand.getFood();
        Food previous = new Food(compAux.getId(), compAux.getName(), compAux.getType());
        
        //Invocamos el comando eliminar
        invoker.setCommand(new DeleteCommand());
        //Pasa parámetros al comando
        DeleteCommand deleteCommand = (DeleteCommand) invoker.getCommand();
        deleteCommand.setIdFood(Integer.parseInt(strId));
        deleteCommand.setDeletedFood(previous);
        //Ejecuta el comando
        invoker.execute();
        boolean state = deleteCommand.isState();
        if(state){
