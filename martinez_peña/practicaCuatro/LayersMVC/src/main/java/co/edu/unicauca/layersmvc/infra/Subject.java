...
public abstract class Subject {
     ...
     */
    public void notifyAllObserves(Product producto, String accion) throws Exception {

        for (Observer each : observers) {
            each.update(this);
        }     
        IPublisher Publicador = new RabbitMqPublisher();
        Publicador.Publish(producto, accion);
    }
