...
import com.mycompany.negocio.Viaje;
import com.mycompany.negocio.ViajeFamiliar;
import com.mycompany.negocio.ViajeIncentivo;
import com.mycompany.negocio.ViajeIndividual;
import com.mycompany.negocio.ViajeTodoIncluido;
    ...
    public static void leerViajes() {
        try {
            Viaje viaje1 = new ViajeFamiliar("Popayán", "Bogotá", 1250000, 
                    new SimpleDateFormat("dd/MM/yyyy").parse("01/05/2019"), new SimpleDateFormat("dd/MM/yyyy").parse("05/05/2019"), 5);
            viajes.add(viaje1);
            
            Viaje viaje2 = new ViajeIncentivo("Popayán", "Medellin", 2100000, 
                    new SimpleDateFormat("dd/MM/yyyy").parse("03/06/2019"), new SimpleDateFormat("dd/MM/yyyy").parse("09/06/2019"), "Emtel");
            viajes.add(viaje2);
