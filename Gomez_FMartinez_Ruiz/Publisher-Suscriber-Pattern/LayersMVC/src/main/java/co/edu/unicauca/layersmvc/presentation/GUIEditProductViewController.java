...
public class GUIEditProductViewController extends javax.swing.JFrame {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        Product newProduct = new Product(Integer.parseInt(txtId.getText()), txtName.getText(), Double.parseDouble(txtValue.getText()), "Actualizar" );
         try {
            if (service.updateProduct(newProduct)){
                clearFields();
            } else {
