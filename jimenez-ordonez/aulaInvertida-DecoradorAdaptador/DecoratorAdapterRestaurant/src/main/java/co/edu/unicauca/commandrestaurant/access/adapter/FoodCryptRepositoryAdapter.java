 ...
 * @author
 */
public class FoodCryptRepositoryAdapter implements IFoodRepository {

    /**
     * Repositorio adaptado
     */
    FoodCryptRepository adaptedRepository;

    /**
     * Constructor
     */
    public FoodCryptRepositoryAdapter() {
        adaptedRepository = new FoodCryptRepository();
    }
